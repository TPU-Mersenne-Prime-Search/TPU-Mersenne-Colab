...
#    print(gathered_input.shape)
  ...
  def fft(self, xs):
    return self.fft_1d(jnp.expand_dims(jnp.expand_dims(xs, axis=0), axis=0), axis=2)[0][0]
...
transformer = DistFFT(['x','y','z'], partition)
inp = jnp.arange(16*16*8)
axis = 1
X_jax = transformer.fft(inp)
