...
def weighted_transform(signal_to_transform, weight_array):
  ...
  return dft.run([weighted_signal,[]])

def inverse_weighted_transform(transformed_weighted_signal, weight_array):
  weighted_signal, _ = idft.run(transformed_weighted_signal)
...
def squaremod_with_ibdwt(
  ...
  transformed_signal_real, transformed_signal_imag = weighted_transform(balanced_signal, weight_array)
  squared_transformed_signal_real = jnp.multiply(
    transformed_signal_real, transformed_signal_real)
  squared_transformed_signal_imag = jnp.multiply(
    transformed_signal_imag, transformed_signal_imag)
  squared_signal = inverse_weighted_transform(
    [squared_transformed_signal_real, squared_transformed_signal_imag], weight_array)
...
def multmod_with_ibdwt(signal1, signal2, prime_exponent,
  ...
  transformed_signal1_real, transformed_signal1_imag = weighted_transform(balanced_signal1, weight_array)
  transformed_signal2_real, transformed_signal2_imag = weighted_transform(balanced_signal2, weight_array)
  multiplied_transformed_signal_real = jnp.multiply(
    transformed_signal1_real, transformed_signal2_real)
  multiplied_transformed_signal_imag = jnp.multiply(
    transformed_signal1_imag, transformed_signal2_imag)
  multiplied_signal = inverse_weighted_transform(
    [multiplied_transformed_signal_real, multiplied_transformed_signal_imag], weight_array)
